...
export default class UpdateMaterial extends Component {
    ...
    componentDidMount(){
        MaterialService.getMaterialById(this.state.id).then((res) => {
            let material = res.data;
            this.setState({mtr_no:material.mtr_no,
                mtr_name: material.mtr_name,
                mtr_vendor: material.mtr_vendor,
                mtr_max_stock: material.mtr_max_stock,
                mtr_min_stock: material.mtr_min_stock,
                mtr_duration: material.mtr_duration,
                mtr_status: material.mtr_status,
                mtr_bin: material.mtr_bin
            });
    ...
    updateMaterial = (e) => {
     ...
     MaterialService.updateMaterial(material,this.state.id).then(res =>{
          this.props.history.push('/Products'); 
         });

        // MaterialService.createMaterial(material,this.state.mtr_id).then(res =>{
        //     this.props.history.push('/Products')
